...
<div class="col-md-6 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <p class="card-title">School Statistics</p>
            <p class="font-weight-500">An overview of key metrics related to school performance, including
                student and teacher engagement.</p>
            <div class="d-flex flex-wrap mb-5">
                <div class="me-5 mt-3">
                    <p class="text-muted">Total Students</p>
                    <h3 class="text-primary fs-30 font-weight-medium">1,234</h3>
                </div>
                <div class="me-5 mt-3">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                                <div class="ml-xl-4 mt-3">
                                    <p class="card-title">Previous Year Exam Results</p>
                                    <h1 class="text-primary">1,234</h1>
                                    <h3 class="font-weight-500 mb-xl-4 text-primary">Total Students</h3>
                                    <p class="mb-2 mb-xl-0">Overview of students' performance in the
                                        previous year's exams.</p>
                                </div>
                            </div>
                                        ...
                                        <div class="table-responsive mb-3 mb-md-0 mt-3">
                                            <table class="table table-borderless report-table">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="font-weight-bold mb-0">1,234</h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">Students Passed</td>
                                                    <td class="w-100 px-0">
                                                        <div class="progress progress-md mx-4">
                                                    ...
                                                    <td>
                                                        <h5 class="font-weight-bold mb-0">1,049</h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">Students with Backlogs</td>
                                                    <td class="w-100 px-0">
                                                        <div class="progress progress-md mx-4">
                                                    ...
                                                    <td>
                                                        <h5 class="font-weight-bold mb-0">185</h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">Percentage Passed</td>
                                                    <td class="w-100 px-0">
                                                        <div class="progress progress-md mx-4">
                                                            <div class="progress-bar bg-success"
                                                                role="progressbar" style="width: 85%"
                                                    ...
                                                    <td>
                                                        <h5 class="font-weight-bold mb-0">85%</h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">Percentage Backlogs</td>
                                                    <td class="w-100 px-0">
                                                        <div class="progress progress-md mx-4">
                                                            <div class="progress-bar bg-danger"
                                                                role="progressbar" style="width: 15%"
